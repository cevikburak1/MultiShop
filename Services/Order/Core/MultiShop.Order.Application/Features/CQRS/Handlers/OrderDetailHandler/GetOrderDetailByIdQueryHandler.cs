...
namespace MultiShop.Order.Application.Features.CQRS.Handlers.OrderDetailHandler
{
    public class GetOrderDetailByIdQueryHandler
    {
        ...
        public async Task<GetOrderDetailByIdQueryResult> Handle(GetOrderDetailByIdQuery getOrderDetailByIdQueryResult)
        {
            var result = await _repository.GetByIdAsync(getOrderDetailByIdQueryResult.Id);
